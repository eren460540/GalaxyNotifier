--This file was leaked by @imguy_6677
--https://discord.gg/3Y5G8tPCJX
...
local function startESP()
    ...
    getgenv().BestPetESP.loop = task.spawn(function()
        while getgenv().BestPetESP.active do
                            ...
                            if gen and gen:IsA("TextLabel") and gen.Text ~= "" then
                                ...
                                if numVal >= 10000000 then -- Mostra e invia solo dai 10 Milioni in su
                                    ...
                                    if part and part:IsA("BasePart") then
                                        -- Sistema Anti-Crash: Registra un ID unico per questo server, così non lo re-invia mille volte
            ...
            -- Pulizia Memory Leak: Rimuove l'ESP se la parte è stata distrutta
